...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private Rol getRoles(Role rolBuscada){
        return rolRepository.findByNombreRol(rolBuscada.name()).orElseThrow(()->new RuntimeException("Error el rol no existe" + rolBuscada.name()));
    }
}
